...
let currentMarker = 'X';// The variable will change from X to O based on what player turn it is. We need to hold this so we can place an X or O on the board when they're clicked.
...
const handleClick = (element) => { 
  ...
  console.log(`The element you clicked on has an id:  ${element.id}`)   // this uses the "log" method on the "console" to log out the element's id so we can see it with our human eyes
...
const diagonalWin = () => {
  console.log("diagnonal function***")
  if(
